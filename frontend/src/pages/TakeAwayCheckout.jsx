...
const TakeAwayCheckout = () => {
  ...
  return (
    <div className="checkout-page">
      ...
      {/* Floating card */}
      <main className="checkout-main" style={{ marginTop: '50px' }}>
        <div className="checkout-card">
          {/* Back link */}
          <Link to="/take-away" className="checkout-back-link">
            ← Back to Menu
          </Link>
          ...
          <div className="checkout-body">
            ...
            <div className="checkout-form-section">
              ...
              <p className="checkout-order-type">Take Away Order</p>
